...
var editorDescription = new Editor({element: document.getElementById('textareaDescription')});
document.getElementById('editorDescription').className = 'editorDescription';